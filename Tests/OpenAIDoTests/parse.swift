...
func parse<A>(_ arguments: String..., as type: A.Type = A.self, file: StaticString = #filePath, line: UInt = #line) throws -> A where A: ParsableCommand {
  var result: A?
...
func parseFail<A>(_ arguments: String..., as type: A.Type, file: StaticString = #filePath, line: UInt = #line) {
