...
struct TextCommand: AsyncParsableCommand {
  static var configuration = CommandConfiguration(
    commandName: "text",
    abstract: "Commands relating to text.",
    subcommands: [
      TextCompletionsCommand.self,
      TextEditsCommand.self,
    ]
  )
}
...
struct TextCompletionsCommand: AsyncParsableCommand {
  static var configuration = CommandConfiguration(
    commandName: "completions",
    abstract: "Creates completions for the provided prompt and parameters."
  )
...
//  var stream: Bool?
  ...
  mutating func run() async throws {
    ...
    let completions = Text.Completions(
...
struct TextEditsCommand: AsyncParsableCommand {
  static var configuration = CommandConfiguration(
    commandName: "edits",
